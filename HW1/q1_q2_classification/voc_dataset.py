...
class VOCDataset(Dataset):
    ...
    def preload_anno(self):
        ...
        for index in self.index_list:
            ...
            for obj in root.findall("object"):
                ...
                classes_present_names.append(class_name)

            for class_name in classes_present_names:
            ...
            for obj in root.findall("object"):
                ...
                class_name = obj.find("name").text
                difficulties.append((class_name, difficult))

            for class_name, difficult in difficulties:
                class_index = self.get_class_index(class_name)
                if difficult == "1":
    ...
    def get_random_augmentations(self):
        ...
        # This function should return a list of data augmentation
        # I'll need to check which dataset I'm using (train, validation, or test)
